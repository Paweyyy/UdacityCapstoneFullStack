...
def create_app(test_config=None):
    ...
    def create_movie():
        ...
        ncrd = datetime.strptime(new_release_date, '%d/%m/%y %H:%M:%S')
        movie = Movie(title=new_title, release_date=ncrd)
        movie.insert()
    ...
    def update_movie(movie_id):
        ...
        if "release_date" in body.keys():
            movie.release_date = datetime.strptime(body["release_date"],
                                                   '%d/%m/%y %H:%M:%S')
